#' Download a dataset from the eurostat database (eurostat_url()).
#' 
#' @description Download a dataset from the eurostat database. 
#'              The dataset is transformed into the molten / 
...
#' @details Data is downloaded from \url{http://ec.europa.eu/eurostat/estat-navtree-portlet-prod/BulkDownloadListing}
