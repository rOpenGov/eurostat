...
#' [GISCO: General information on geo-datafiles](https://ec.europa.eu/eurostat/web/gisco/geodata)
#'
#' "In addition to the [general copyright and licence policy](https://ec.europa.eu/eurostat/help/copyright-notice) applicable to the whole Eurostat website, the following
...
#' [Eurostat website](https://ec.europa.eu/eurostat/help/copyright-notice)
#'
