...
#> Table lfsq_egan22d cached at /tmp/RtmpP44Z08/eurostat/1645e05595bcc5baffaddf220c949593.rds
...
#> Table sbs_na_1a_se_r2 cached at /tmp/RtmpP44Z08/eurostat/a79e30c29469a0fa20c779236f38172e.rds
...
#> Table sbs_na_ind_r2 cached at /tmp/RtmpP44Z08/eurostat/edaaf4bdd9bf25f6fb63d830f956d828.rds
...
#> Reading cache file /tmp/RtmpP44Z08/eurostat/1645e05595bcc5baffaddf220c949593.rds
#> Table  lfsq_egan22d  read from cache file:  /tmp/RtmpP44Z08/eurostat/1645e05595bcc5baffaddf220c949593.rds
stats_label <- label_eurostat(stats, code = "nace_r2")
```
...
#> Table ext_lt_intertrd cached at /tmp/RtmpP44Z08/eurostat/4dc4d78d03f6ae309065425c8974a96e.rds
...
#> Table ext_tec09 cached at /tmp/RtmpP44Z08/eurostat/06f88fc841db727847b751d87e346105.rds
```
...
#> Dataset query already saved in cache_list.json...
#> Reading cache file /tmp/RtmpP44Z08/eurostat/a79e30c29469a0fa20c779236f38172e.rds
#> Table  sbs_na_1a_se_r2  read from cache file:  /tmp/RtmpP44Z08/eurostat/a79e30c29469a0fa20c779236f38172e.rds
head(music_business1)
#> # A tibble: 6 × 6
#>   freq  nace_r2 indic_sb geo       time       values
#>   <chr> <chr>   <chr>    <chr>     <date>      <dbl>
...
#> Dataset query already saved in cache_list.json...
#> Reading cache file /tmp/RtmpP44Z08/eurostat/edaaf4bdd9bf25f6fb63d830f956d828.rds
#> Table  sbs_na_ind_r2  read from cache file:  /tmp/RtmpP44Z08/eurostat/edaaf4bdd9bf25f6fb63d830f956d828.rds
head(music_business2)
#> # A tibble: 6 × 6
#>   freq  nace_r2 indic_sb geo       time       values
#>   <chr> <chr>   <chr>    <chr>     <date>      <dbl>
