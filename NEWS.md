...
* `eurotime2num` can now handle monthly and weekly data as well. Please note that for those rare but regularly occurring years with 54 weeks returning the time as a numeric does not result in a fraction clearly belonging to the actual year (such as 2000.98) but as a fraction belonging to the next year (2001.00). A message will be displayed when the dataset contains data in weekly intervals and if the week numbers go up to 54 in any year.
