...
Contributions are very welcome. You can, for instance:
  ...
  * Provide feedback and bug reports via [issue tracker](https://github.com/ropengov/eurostat/issues) or on the [mailing list](https://github.com/rOpenGov/eurostat/blob/master/DESCRIPTION)
