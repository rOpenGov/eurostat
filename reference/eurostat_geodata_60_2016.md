...
- **geo**: Same as NUTS_ID, added for for easier joins with dplyr.
  However, it is recommended to use other identical fields for this
  purpose.
...
[`giscoR::gisco_get_nuts()`](https://ropengov.github.io/giscoR/reference/gisco_get_nuts.html)
and [Eurostat. (2019). Methodological manual on territorial typologies –
2018 edition. Manuals and
