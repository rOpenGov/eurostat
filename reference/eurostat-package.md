...
is available or for structural changes, for example for the dimensions
in the dataset.

The Eurostat database always contains the latest version of the
datasets, meaning that there is no versioning or documentation of past
...
- Read
  [`get_eurostat()`](https://ropengov.github.io/eurostat/reference/get_eurostat.md)
  function documentation carefully so you understand what different
  arguments do
