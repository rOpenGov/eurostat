...
[`tmap`](https://github.com/mtennekes/tmap) package.
    ...
    ## Table tgs00026 cached at /tmp/RtmpY65FJW/eurostat/tgs00026_raw_code_FF.rds
...
### Disposable income of private households by NUTS 2 regions at 1:10mln resolution using spplot
    ...
    ## Reading cache file /tmp/RtmpY65FJW/eurostat/tgs00026_raw_code_FF.rds

    ## Table  tgs00026  read from cache file:  /tmp/RtmpY65FJW/eurostat/tgs00026_raw_code_FF.rds
    ...
    ## SpatialPolygonDataFrame at resolution 1: 10  cached at:  /tmp/RtmpY65FJW/eurostat/spdf1022013.RData
...
BSD-2-clause (modified FreeBSD) license:
    ...
    ##   package. R Journal 9(1):385-392, 2017. Version 3.2.50001 Package
...
This tutorial was created with
    ...
    ## [16] eurostat_3.2.50001 devtools_1.13.6   
    ## 
