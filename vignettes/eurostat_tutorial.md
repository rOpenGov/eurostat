...
[`tmap`](https://github.com/mtennekes/tmap) package.
    ...
    ## Table tgs00026 cached at /tmp/Rtmpdpowf5/eurostat/tgs00026_raw_code_FF.rds
...
### Disposable income of private households by NUTS 2 regions at 1:10mln resolution using spplot
    ...
    ## Reading cache file /tmp/Rtmpdpowf5/eurostat/tgs00026_raw_code_FF.rds

    ## Table  tgs00026  read from cache file:  /tmp/Rtmpdpowf5/eurostat/tgs00026_raw_code_FF.rds
    ...
    ## SpatialPolygonDataFrame at resolution 1: 10  cached at:  /tmp/Rtmpdpowf5/eurostat/spdf1022013.RData
...
BSD-2-clause (modified FreeBSD) license:
    ...
    ##   package. R Journal 9(1):385-392, 2017. Version 3.2.30002 Package
...
This tutorial was created with
    ...
    ## [13] eurostat_3.2.30002 rmarkdown_1.10     knitr_1.20        
    ## 
    ## loaded via a namespace (and not attached):
    ##  [1] nlme_3.1-137       bitops_1.0-6       satellite_1.0.1   
    ##  [4] lubridate_1.7.4    webshot_0.5.0.9000 httr_1.3.1        
    ##  [7] rprojroot_1.3-2    mapview_2.4.0      tools_3.5.1       
    ## [10] backports_1.1.2    rgdal_1.3-3        R6_2.2.2          
    ## [13] KernSmooth_2.23-15 spData_0.2.9.0     rgeos_0.3-28      
    ## [16] DBI_1.0.0          lazyeval_0.2.1     colorspace_1.3-2  
    ## [19] raster_2.6-7       withr_2.1.2        tidyselect_0.2.4  
    ## [22] leaflet_2.0.1      curl_3.2           compiler_3.5.1    
    ## [25] Cairo_1.5-9        labeling_0.3       scales_1.0.0      
    ## [28] classInt_0.2-3     readr_1.1.1        stringr_1.3.1     
    ## [31] digest_0.6.15      R.utils_2.6.0      base64enc_0.1-3   
    ## [34] dichromat_2.0-0    pkgconfig_2.0.1    htmltools_0.3.6   
    ## [37] highr_0.7          htmlwidgets_1.2    rlang_0.2.1       
    ## [40] shiny_1.1.0        bindr_0.1.1        jsonlite_1.5      
    ## [43] crosstalk_1.0.0    R.oo_1.22.0        RCurl_1.95-4.11   
    ## [46] magrittr_1.5       Rcpp_0.12.18       munsell_0.5.0     
    ## [49] R.methodsS3_1.7.1  stringi_1.2.4      yaml_2.2.0        
    ## [52] tmaptools_2.0      plyr_1.8.4         grid_3.5.1        
    ## [55] promises_1.0.1     crayon_1.3.4       lattice_0.20-35   
    ## [58] hms_0.4.2          pillar_1.3.0       gdalUtils_2.0.1.14
    ## [61] codetools_0.2-15   stats4_3.5.1       XML_3.98-1.12     
    ## [64] glue_1.3.0         evaluate_0.11      png_0.1-7         
    ## [67] httpuv_1.4.5       foreach_1.4.4      gtable_0.2.0      
    ## [70] purrr_0.2.5        assertthat_0.2.0   mime_0.5          
    ## [73] lwgeom_0.1-4       xtable_1.8-2       broom_0.5.0       
    ## [76] e1071_1.7-0        later_0.7.3        class_7.3-14      
    ## [79] viridisLite_0.3.0  tibble_1.4.2       iterators_1.0.10  
    ## [82] units_0.6-0
