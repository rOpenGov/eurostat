...
For the map example, look at Figure `r fig$ref("mapexample")`.

```{r 2015-manu-RJournal_map_example, warning=FALSE, message=FALSE, echo=FALSE, eval=TRUE, fig.cap=fig$cap("mapexample", "Eurostat spatial visualization example.")}
# Clean the cache
...
```{r 2015-manu-searchdata, echo=FALSE, eval=TRUE, fig.width=5, fig.height=5}
...
```{r 2015-manu-roadaccidents, echo=FALSE, eval=TRUE, fig.width=5, fig.height=5, fig.cap="Caption for this figure goes here."}
...
```{r 2015-manu-bmi, echo=FALSE, eval=TRUE} 
