...
```{r 2015-manu-RJournal_map_example, warning=FALSE, message=FALSE, echo=FALSE, eval=TRUE, fig.cap=fig$cap("2015-manu-RJournal_map_example", "Eurostat spatial visualization example."), anchor="figure"}
# Clean the cache
