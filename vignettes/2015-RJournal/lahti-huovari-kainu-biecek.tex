...
The entries in many columns of the Table~\ref{tab:getdatatable} are
...
standards with the \CRANpkg{countrycode} R
...
the \CRANpkg{spacetime} package \cite{spacetime}, and construct
