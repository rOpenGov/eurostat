...
Also the \CRANpkg{datamart} \citep{datamart} and the
\CRANpkg{quandl}
\citep{quandl} R packages provide tools to access
...
The \CRANpkg{eurostat} package greatly benefits from external tools
available via
