...
\begin{figure}
<<2015-manu-mapexample, echo=FALSE, warning=FALSE, error=FALSE, eval=TRUE, fig.width=7, fig.height=7, out.width='.8\\linewidth', fig.path='fig/', fig.align='center', fig.show='asis', fig=TRUE, dpi=300, cache=TRUE>>=
# Clean the cache
...
<<2015-manu-searchdata, echo=FALSE, warning=FALSE, error=FALSE, eval=TRUE, fig=TRUE, fig.width=7, fig.height=7, dpi=300, cache=TRUE, out.width='.8\\linewidth', fig.path='fig/', fig.align='center', fig.show='asis'>>=
...
<<2015-manu-roadaccidents, echo=FALSE, warning=FALSE, error=FALSE, eval=TRUE, fig=TRUE, fig.width=7, fig.height=7, dpi=300, out.width='.8\\linewidth', fig.path='fig/', fig.align='center', fig.show='asis'>>=
...
<<2015-manu-bmi, echo=FALSE, warning=FALSE, error=FALSE, eval=TRUE, fig=TRUE, fig.width=7, fig.height=7, out.width='.8\\linewidth', fig.path='fig/', fig.align='center', fig.show='asis'>>=
