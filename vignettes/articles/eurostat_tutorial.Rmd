...
The package supports two of the Eurostats download methods: the SDMX 2.1 REST API (old bulk download facility) and the Eurostat Web Services ("JSON API"). The bulk download facility is thefastest method to download whole datasets. 
