...
Using `tmap::tmap_mode('view')`, it is also easy to produce interactive maps. The zoom is not ideal
in this example, but you scroll and zoom around using your mouse.

```{r maps1-2, eval=TRUE, fig.width=8, fig.height=8}
tmap_mode("view")
map1
...
map2 <- tm_shape(Europe) +
  ...
  tm_polygons("income", title = "Disposable household incomes in 2005",
