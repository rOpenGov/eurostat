 ...
 * Retrieval and analysis of Eurostat open data with the eurostat package. R Journal 2017. ([manuscript](https://journal.r-project.org/archive/2017/RJ-2017-019/index.html); [source code](https://github.com/rOpenGov/eurostat/blob/master/vignettes/2017_RJournal_manuscript/README)). 
